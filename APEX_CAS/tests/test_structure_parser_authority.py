"""Regression tests for the shared structure-parser authority.

Covers formula generation, symmetry detection, metal-center identification,
bridging-atom identification, and bond/connectivity primitives.
"""
...
from shared.structure_parser import (
    TRANSITION_METALS,
    COVALENT_RADII,
    BRIDGING_ELEMENTS,
    _generate_formula,
    _detect_symmetry_details,
...
class TestDetectSymmetry(unittest.TestCase):
    ...
    def test_c3_equilateral_triangle(self):
        ...
        details = _detect_symmetry_details(metals, None)
        sym = details["symmetry_group"]
    ...
    def test_no_symmetry_single_metal(self):
        ...
        details = _detect_symmetry_details(metals, None)
        self.assertEqual(details["symmetry_group"], "C1")
