"""Tests for canonical Step-2 electronic configuration generation.
...
from apex_filter.elec_spin_config_generator import (
    _enumerate_d_orbital_configs,
    _enumerate_oxidation_assignments,
...
class TestEnumerateOxidationAssignments(unittest.TestCase):
    ...
    @patch("apex_filter.elec_spin_config_generator._estimate_ligand_charge")
    def test_fe2s2_assignments(self, mock_ligand_charge):
        ...
        results = _enumerate_oxidation_assignments(cluster)
    ...
    def test_femoco_18_fe_oxidation_assignments(self, mock_ligand_charge):
        ...
        allowed = {"Fe": [2, 3], "Mo": [3]}
        results = _enumerate_oxidation_assignments(
...
class TestEnumerateDOrbitalConfigs(unittest.TestCase):
    ...
    @patch("apex_filter.elec_spin_config_generator._get_local_spin")
    @patch("apex_filter.elec_spin_config_generator._get_d_electron_count")
    ...
    def test_empty_d_shell(self, mock_d_count, mock_spin):
        ...
        choices = _enumerate_d_orbital_configs("Sc", 3, +1)
        self.assertEqual(len(choices), 0)
    ...
    def test_full_d_shell(self, mock_d_count, mock_spin):
        ...
        choices = _enumerate_d_orbital_configs("Zn", 2, +1)
        self.assertEqual(len(choices), 0)
    ...
    def test_mo_iii_d3(self, mock_d_count, mock_spin):
        ...
        choices = _enumerate_d_orbital_configs("Mo", 3, -1)
        self.assertEqual(len(choices), 0)
...
class TestGenerateAllConfigs(unittest.TestCase):
    ...
    @patch("apex_filter.elec_spin_config_generator._enumerate_oxidation_assignments")
    @patch("apex_filter.elec_spin_config_generator._enumerate_spin_isomers")
    @patch("apex_filter.elec_spin_config_generator._get_d_orbital_choices_for_cluster")
    def test_generates_config_objects(self, mock_d_choices, mock_spin_isomers, mock_ox_assign):
        ...
        mock_spin_isomers.return_value = [isomer]
    ...
    @patch("apex_filter.elec_spin_config_generator._enumerate_spin_isomers")
    @patch("apex_filter.elec_spin_config_generator._get_d_orbital_choices_for_cluster")
    def test_d_orbital_choices_expand_configs(self, mock_d_choices, mock_spin_isomers, mock_ox_assign):
    ...
    @patch("apex_filter.elec_spin_config_generator._enumerate_spin_isomers")
    @patch("apex_filter.elec_spin_config_generator._get_d_orbital_choices_for_cluster")
    def test_max_configs_limit(self, mock_d_choices, mock_spin_isomers, mock_ox_assign):
        ...
        configs = generate_all_configs(cluster, max_configs=3)
...
class TestHelperFunctions(unittest.TestCase):
    """Regression coverage for Step 2 labeling and oxidation helpers."""
