"""Tests for canonical Step-2 spin enumeration.
...
from apex_filter.elec_spin_config_generator import (
    _apply_symmetry_reduction,
    _enumerate_spin_isomers,
    _label_isomers,
    _parse_fold,
    _rotation_matrix,
)
...
class TestEnumerateSpinIsomers(unittest.TestCase):
    ...
    @patch("apex_filter.elec_spin_config_generator._get_common_oxidation_states")
    ...
    def test_empty_cluster_returns_empty(self):
        ...
        isomers = _enumerate_spin_isomers(cluster, target_Sz=1.5)
    ...
    def test_target_Sz_from_cluster_info(self):
        ...
        with patch("apex_filter.elec_spin_config_generator._get_common_oxidation_states", return_value=[3]), \
             patch("apex_filter.elec_spin_config_generator._get_local_spin", return_value=2.5):
            isomers = _enumerate_spin_isomers(cluster)
...
class TestApplySymmetryReduction(unittest.TestCase):
    ...
    def test_c1_no_reduction(self):
        ...
        families = _apply_symmetry_reduction(isomers, symmetry_group="C1")
    ...
    def test_empty_isomers(self):
        ...
        families = _apply_symmetry_reduction([], symmetry_group="C3")
    ...
    def test_c3_symmetry_with_equilateral_positions(self):
        ...
        families = _apply_symmetry_reduction(
...
class TestHelperFunctions(unittest.TestCase):
    """Regression coverage for Step 2 symmetry and rotation internals."""
...
class TestLabelIsomers(unittest.TestCase):
    ...
    def test_label_families(self):
        ...
        labeled = _label_isomers(families)
